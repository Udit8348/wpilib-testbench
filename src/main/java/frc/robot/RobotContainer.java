...
public class RobotContainer {
  ...
  // dashboard
  private static final String kIndexerUnjamSpd = "Indexer Unjam Speed";
  private final double kDefaultIndexerUnjamSpd = 0.5;

  private static final String kIndexerLaunchSpd = "Indexer Launch Speed";
  private final double kDefaultIndexerLaunchSpd = -0.8;

  private static final String kShooterLaunchSpd = "Shooter Launch Speed";
  private final double kDefaultShooterLaunchSpd = 0.7;
